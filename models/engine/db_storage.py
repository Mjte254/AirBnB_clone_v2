...
class DBStorage:
        """This class creates the engine for a MySQL database storage system"""
          ...
          def all(self, cls=None):
              ...
              if cls:
                  ...
                  for class_name in self.all_classes:
                      objects.extend(self.__session.query(self.all_classes[class_name]).all())
              for obj in objects:
         ...
         def reload(self):
             ...
             session_factory = sessionmaker(bind=self.__engine, expire_on_commit=False)                                                                                            Session = scoped_session(session_factory)
